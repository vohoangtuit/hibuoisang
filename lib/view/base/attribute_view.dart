          ...
          SizedBox(
            ...
            ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return InkWell(
                  onTap: () => resProvider.toggleAttribute(index, widget.product),
                  child: Container(
                ...
                Row(children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [BoxShadow(color: Colors.grey[Provider.of<ThemeProvider>(context).darkTheme ? 700 : 300], blurRadius: 5, spreadRadius: 1)],
                      borderRadius: BorderRadius.circular(Dimensions.PADDING_SIZE_SMALL),
                    ),
                    child: Text(
                        resProvider.attributeList[index].attribute.name, maxLines: 2, textAlign: TextAlign.center,
                    ...
                    itemBuilder: (context, i) {
                      return Container(
                        ...
                        child: Row(children: [
                          ...
                          InkWell(
                            onTap: () => resProvider.removeVariant(index, i, widget.product),
                            child: Padding(
