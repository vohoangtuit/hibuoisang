                              ...
                              child: FittedBox(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: CachedNetworkImage(
                                    ...
                                    imageUrl: '${Provider.of<SplashProvider>(context,listen: false).baseUrls.shopImageUrl}/${resProvider.shopModel.banner}',),
                                ),
                              ),
                            ),
                            ...
                            builder: (context,shopProvider,child)=>PageView.builder(
                              ...
                              itemBuilder: (context, index) {
                                if (shopProvider.selectedIndex == 0) {
                                  return ProductView(scrollController: _scrollController);
                                } else {
