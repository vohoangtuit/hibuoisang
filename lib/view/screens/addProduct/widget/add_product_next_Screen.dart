...
class AddProductNextScreen extends StatefulWidget {
  ...
  AddProductNextScreen({this.isSelected, @required this.product, @required this.category,@required this.title, @required this.description,@required this.addProduct});
...
class _AddProductNextScreenState extends State<AddProductNextScreen> {
  ...
  void initState() {
    ...
    Provider.of<RestaurantProvider>(context,listen: false).getAttributeList(context, widget.product);
    Provider.of<RestaurantProvider>(context,listen: false).getCategoryList(context);
    Provider.of<RestaurantProvider>(context,listen: false).getSubCategoryList(context,0);
    Provider.of<RestaurantProvider>(context,listen: false).getBrandList(context);
    Provider.of<SplashProvider>(context,listen: false).configModel.unit;


    if(_update) {
      _unitPriceController.text = PriceConverter.convertPrice(context, _product.unitPrice);
      ...
      _purchasePriceController.text = PriceConverter.convertPrice(context, _product.purchasePrice);
      Provider.of<RestaurantProvider>(context,listen: false).setDiscountTypeIndex(_product.discountType == 'percent' ? 0 : 1, false);
    }else {
      _product = Product();
  ...
  route(bool isRoute, String name, String type) async {
    if (isRoute) {
      ...
      counter++;
      if(metaImage ==''){
        total = Provider.of<RestaurantProvider>(context,listen: false).coveredImage.length + 1;
      }else{
        if(_update){
          if(thumbnailImage==''){
            total = Provider.of<RestaurantProvider>(context,listen: false).coveredImage.length;
          }
        }
        total = Provider.of<RestaurantProvider>(context,listen: false).coveredImage.length + 2;
      }
        if(counter == total){
        ...
        child: Padding(
          ...
          child: Consumer<RestaurantProvider>(
            builder: (context, resProvider, child){
              ...
              _brandIds.add(0);
              if(resProvider.categoryList != null ) {
                for(int index = 0; index < resProvider.categoryList.length; index++) {
                  _categoryIds.add(resProvider.categoryList[index].id);
                }
                if(_update) {
                  Provider.of<RestaurantProvider>(context).setCategoryIndex(_categoryIds.indexOf(int.parse(_product.categoryIds[0].id)), false);
                  print('------${_categoryIds.indexOf(int.parse(_product.categoryIds[0].id))}');
                  resProvider.getSubCategoryList(context, _categoryIds.indexOf(int.parse(_product.categoryIds[0].id)));
                }
              }
              if (resProvider.subCategoryList != null) {
                for (int index = 0; index < resProvider.subCategoryList.length; index++) {
                  _subCategoryIds.add(resProvider.subCategoryList[index].id);
                }
                if (_update && _product.categoryIds.length > 1) {
                  print('=====${_product.categoryIds[1].id}/$_subSubCategoryIds');
                  resProvider.setSubCategoryIndex(_subCategoryIds.indexOf(int.parse(_product.categoryIds[1].id)), false);
                }
              }
              if (resProvider.subSubCategoryList != null) {
                for (int index = 0; index < resProvider.subSubCategoryList.length; index++) {
                  _subSubCategoryIds.add(resProvider.subSubCategoryList[index].id);
                }
                if (_update && _product.categoryIds.length > 2) {
                  resProvider.setSubCategoryIndex(_subCategoryIds.indexOf(int.parse(_product.categoryIds[2].id)), false);
                }
              }
              print('-----${resProvider.subCategoryIndex}');
              ...
              if(resProvider.brandList != null) {
                ...
                if(_update) {
                  Provider.of<RestaurantProvider>(context).setBrandIndex(_brandIds.indexOf(_product.brandId), false);

                }
              }
              if(Provider.of<SplashProvider>(context,listen: false).configModel.unit != null){
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: DropdownButton<int>(
                        ...
                        items: _categoryIds.map((int value) {
                        return DropdownMenuItem<int>(
                          value: _categoryIds.indexOf(value),
                          child: Text(value != 0? resProvider.categoryList[(_categoryIds.indexOf(value) -1)].name: 'Select'),
                        );
                      }).toList(),
                        onChanged: (int value) {
                          print('value ==== $value =====>$_categoryIds');
                          resProvider.changeSelectedIndex(value);
                          resProvider.setCategoryIndex(value, true);
                          resProvider.getSubCategoryList(context, value != 0 ? (resProvider.categorySelectedIndex) : 0);
                          },
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(color: Theme.of(context).cardColor,
                                  borderRadius: BorderRadius.circular(Dimensions.PADDING_SIZE_SMALL), boxShadow: [
                                    BoxShadow(color: Colors.grey[Provider.of<ThemeProvider>(context).darkTheme ? 800 : 200], spreadRadius: 2, blurRadius: 5, offset: Offset(0, 5))
                                  ],
                                ),
                                child: DropdownButton<int>(
                                  value: resProvider.subCategoryIndex,
                                  items: _subCategoryIds.map((int value) {
                                    return DropdownMenuItem<int>(
                                      value: _subCategoryIds.indexOf(value),
                                      child: Text(value != 0 ? resProvider.subCategoryList[(_subCategoryIds.indexOf(value) - 1)].name : 'Select'),
                                    );
                                  }).toList(),
                                  onChanged: (int value) {
                                    resProvider.setSubCategoryIndex(value, true);
                                    resProvider.changeSubCategorySelectedIndex(value);
                                    resProvider.getSubSubCategoryList(context, value != 0 ? resProvider.subCategorySelectedIndex : 0);
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  boxShadow: [BoxShadow(color: Colors.grey[Provider.of<ThemeProvider>(context).darkTheme ? 800 : 200], spreadRadius: 2, blurRadius: 5, offset: Offset(0, 5))],
                                ),
                                child: DropdownButton<int>(
                                  value: resProvider.subSubCategoryIndex,
                                  items: _subSubCategoryIds.map((int value) {
                                    return DropdownMenuItem<int>(
                                      value: _subSubCategoryIds.indexOf(value),
                                      child: Text(value != 0 ? resProvider.subSubCategoryList[(_subSubCategoryIds.indexOf(value)-1)].name : 'Select'),
                                    );
                                  }).toList(),
                                  onChanged: (int value) {
                                ...
                                child: DropdownButton<int>(
                                  ...
                                  items: _brandIds.map((int value) {
                                    return DropdownMenuItem<int>(
                                      ...
                                      child: Text(value != 0 ? resProvider.brandList[(_brandIds.indexOf(value)-1)].name : 'Select'),
                                    );
                                  }).toList(),
                                  onChanged: (int value) {
                                    resProvider.setBrandIndex(value-1, true);
                    ...
                    Row(
                      children: [
                        ...
                        Switch(value: resProvider.attributeList[0].active,
                          onChanged: (value){
                          resProvider.toggleAttribute(0, widget.product);
                        },
                    ...
                    Consumer<SplashProvider>(builder: (ctx, colorProvider, child){
                      ...
                      return Autocomplete<int>(
                        ...
                        fieldViewBuilder:
                          ...
                          return Container(
                            height: 50, decoration: BoxDecoration(color: Theme.of(context).cardColor,
                              borderRadius: BorderRadius.circular(Dimensions.PADDING_SIZE_SMALL),
                              boxShadow: [BoxShadow(
                                    color: Colors.grey[Provider.of<ThemeProvider>(context).darkTheme ? 800 : 200],
                                    spreadRadius: 2, blurRadius: 5, offset: Offset(0, 5))
                              ],
                            ),
                            child: TextField(
                        ...
                        onSelected: (int value) {
                          resProvider.addVariant(0,colorProvider.colorList[value].name, widget.product);
                        ...
                        itemBuilder: (context, index) {
                          return Container(
                            ...
                            child: Row(children: [
                              ...
                              InkWell(
                                onTap: (){
                                  resProvider.removeVariant(0, index, widget.product);
                  ...
                  AttributeView(product: widget.product,colorOn: resProvider.attributeList[0].active),
                    ...
                    Align(alignment: Alignment.center, child: Stack(children: [
                      ClipRRect(
                        ...
                        child: resProvider.pickedMeta != null? Image.file(
                          ...
                          image: '${Provider.of<SplashProvider>(context).configModel.baseUrls.productImageUrl}/${_product.metaImage != null ? _product.metaImage : ''}',
                    ...
                    Container(
                      ...
                      child: StaggeredGridView.countBuilder(
                        itemCount: resProvider.coveredImage.length + 1,
                        crossAxisCount: 4, itemBuilder: (BuildContext context, index){
                        return index == resProvider.coveredImage.length ?
                        GestureDetector(
                          ...
                          child: Stack(
                            ...
                            :Container(child: Image.file(File(resProvider.coveredImage[index].path), width: 150, height: 120, fit: BoxFit.cover,
                          ) ,
                          decoration: BoxDecoration(
                              color: Colors.white,
                    ...
                    !resProvider.isLoading
                      ...
                      onTap: (){
                        ...
                        String _brandId =resProvider.brandIndex.toString().trim();
                        ...
                        if (_unitPrice.isEmpty) {
                        ...
                        }else if (!_update && resProvider.coveredImage.length == 0) {
                          ...
                          else if (resProvider.subSubCategoryIndex != 0) {
                            _product.categoryIds.add(CategoryIds(
                        ...
                        if(resProvider.colorCodeList != null){
                          ...
                          _addProduct.languageList = Provider.of<SplashProvider>(context, listen:false).configModel.languageList;
                          ...
                          if(resProvider.coveredImage != null){
                            for(int i =0; i<resProvider.coveredImage.length;i++)
                            {
                              resProvider.addProductImage(resProvider.coveredImage[i],'product', route);
                            }
                          }
                        }
