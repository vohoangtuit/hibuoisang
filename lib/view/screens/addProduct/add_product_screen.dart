                          ...
                          itemBuilder: (ctx, index){
                            return Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  //english
                                  Text(Provider.of<SplashProvider>(context,listen: false).configModel.languageList[index],style: robotoRegular.copyWith(fontWeight: FontWeight.w500)),
                                  SizedBox(height: 25,),
                      ...
                      InkWell(
                        onTap: (){
                          ...
                          if(_haveBlankTitle){
                            ...
                            Navigator.push(context, MaterialPageRoute(builder: (_) => AddProductNextScreen(title: titleList,description: descriptionList,product: widget.product,category: widget.category, addProduct: widget.addProduct,)));

                            // Navigator.of(context).push(MaterialPageRoute(builder: (_) => AddProductNextScreen(title: titleList,description: descriptionList,)));
                          }
