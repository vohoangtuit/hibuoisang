...
//                 children: [
//
//                   Text(getTranslated('your_earnings', context), style: robotoSmallTitleRegular.copyWith(
//                       color: ColorResources.getTextColor(context),
//                       fontSize: Dimensions.FONT_SIZE_SMALL),
//                   ),
//                   SizedBox(height: 5,),
//                   Text(getTranslated('commission_given', context), style: robotoSmallTitleRegular.copyWith(
//                       color: ColorResources.getTextColor(context),
//                       fontSize: Dimensions.FONT_SIZE_SMALL),
//                   ),
//                 ],
...
//         BarChartRodData(
//           y: isTouched ? y + 1 : y,
//           colors: isTouched ? [ColorResources.getPrimary(context)] : [leftBarColor,rightBarColor],
//           width: width,
...
//           showTitles: true,
//           rotateAngle: 45,
//           getTextStyles: (value) => TextStyle(color: Theme.of(context).primaryColor, fontWeight: FontWeight.bold, fontSize: 12),
//           margin: 10,
