              ...
              children: [
                      ...
                      children: [
                        ...
                        Text(
                          (orderModel.paymentMethod != null && orderModel.paymentMethod.length > 0)
                              ...
                              : 'Digital Payment',
                          style: titilliumSemiBold.copyWith(color: ColorResources.getBlue(context),fontSize: 14),
                        ),

                        Expanded(child: SizedBox()),
                        Text(DateConverter.localDateToIsoString(DateTime.parse(orderModel.createdAt)),
                            style: titilliumBold.copyWith(color: ColorResources.getTextColor(context),fontSize: Dimensions.FONT_SIZE_DEFAULT)),
                ...
                Container(
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(' x ${order.orderDetails[index].qty}',
                                ...
                                Expanded(
                                  ...
                                  child: Text(
                                    ...
                                    style: titilliumSemiBold.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL, color: ColorResources.getPrimary(context)),
                                    maxLines: 2,
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      ...
                      Text(
                        PriceConverter.convertPrice(context, _totalPrice),
                        style: titilliumSemiBold.copyWith(fontSize: Dimensions.FONT_SIZE_EXTRA_LARGE, color: Theme.of(context).primaryColor),
                      ),
                    ]),
                ...
                Container(
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Text('${getTranslated('address', context)} : ${orderModel.shippingAddress ?? ''}', style: titilliumRegular),
                    Text('${getTranslated('phone', context)} : ${orderModel.customer.phone ?? ''}', style: titilliumRegular),
                ...
                (order.addOrderStatusErrorText != null && order.addOrderStatusErrorText.isNotEmpty) ? Padding(
                  ...
                  child: Text(
                    ...
                    style: titilliumRegular.copyWith(color: order.addOrderStatusErrorText.contains('updated') ? Colors.green : Colors.red),
                  ),
                ) : SizedBox(),
                SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
