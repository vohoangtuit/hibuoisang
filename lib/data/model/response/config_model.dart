class ConfigModel {
  ...
  ConfigModel({int systemDefaultCurrency, BaseUrls baseUrls, StaticUrls staticUrls, List<CurrencyList> currencyList, List<String> languageList, List<ColorList> colors, List<String> unit, String aboutUs,
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    _languageList = List<String>.from(json["language"].map((x) => x));
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this._languageList != null) {
      data['language'] = List<dynamic>.from(_languageList.map((x) => x));
